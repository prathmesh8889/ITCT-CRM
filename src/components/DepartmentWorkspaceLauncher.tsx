...
export default function DepartmentWorkspaceLauncher() {
  ...
  return <button type="button" onClick={() => navigate("/department-workspace")} title={label}
    className="fixed bottom-4 right-4 z-40 flex items-center gap-2 rounded-full border border-brand-200 bg-surface px-3.5 py-2 text-[11.5px] font-semibold text-brand-700 shadow-lg transition hover:-translate-y-0.5 hover:bg-brand-50 dark:border-brand-900 dark:bg-ink-900 dark:text-brand-300">
